...
[🧠 Previous Meeting Notes](https://github.com/jenkins-infra/documentation/blob/main/meetings/2026-03-31.md)
...
* Done (Milestone [ID](https://github.com/jenkins-infra/helpdesk/milestone/[ID]?closed=1))
  * Keep infrastructure sane and maintainable
    * [[ci.jenkins.io] Data disk passed the 90% usage threshold: need cleanup](https://github.com/jenkins-infra/helpdesk/issues/5065)
    * [Renew `ci.jenkins.io` API token for `incremental-publisher` service before 10 April 2026](https://github.com/jenkins-infra/helpdesk/issues/5061)
    * [Increase TTL of our DNS records from 60 to 300 to reduce costs](https://github.com/jenkins-infra/helpdesk/issues/5051)
    * [Internal Server Error when trying to log in to Uplink](https://github.com/jenkins-infra/helpdesk/issues/5059)
  ...
  * Support
    * [jenkins.io feedburner RSS flux returns malformed URLs](https://github.com/jenkins-infra/helpdesk/issues/5060)
    * [Windows test branches are stuck in GCE plugin builds](https://github.com/jenkins-infra/helpdesk/issues/5055)

* [Closed as not planned](https://github.com/jenkins-infra/helpdesk/milestone/201?closed=1):
  * Support
...
* [x] Publish this meeting record on Youtube: https://youtu.be/_Mk8vWezBdQ
* [x] Publish a topic in community.jenkins.io with the tag `meeting`: https://community.jenkins.io/t/infrastructure-team-meeting-april-14-2026/36806
* [x] Publish this meeting note on [jenkins-infra/documentation](https://github.com/jenkins-infra/documentation) 

Next meeting note - [2026-04-21](https://github.com/jenkins-infra/documentation/blob/main/meetings/2026-04-21.md)
