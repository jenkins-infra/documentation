...
[🧠 Previous Meeting Notes](https://github.com/jenkins-infra/documentation/blob/main/meetings/2026-02-18.md)
...
1. Jenkins Weekly Releases
    ...
    * This Week: 2.553
2. Announcements:
    * AWS renewed their sponsoring \o/
...
* Upcoming credentials expirations (~3 weeks):
    * [trusted.ci] Renew Cloudflare R2 Bucket Credential: 2026-03-10
    * [infra.ci] Fastly Automation token used by Terraform: 2026-03-12
    * [release.ci] Fastly API token expires: 2026-03-15
    * [trusted.ci] Fastly API token expires: 2026-03-15
...
* Azure (CDF paid)
    ...
    * March: $0.5k (forecasted at $5.4)

* Azure Sponsorship (Microsoft Credits): available since the end of February \o/
    * Epic: [Azure Sponsored Subscription 2026: utilizes the 100k$ credits for the Jenkins Infrastructure](https://github.com/jenkins-infra/helpdesk/issues/5003)
        * Starting with cert.ci.jenkins.io (see epic and sub issues for more details)
...
* AWS:
    * Sponsored account
        ...
        * $27,907.47 left on the existing $60k credit line (3rd March 2026) until 31 May 2027
            ...
            * March: $0.4k (forecasted at $10.9)
                

* Jfrog Artifactory Usage
    * Storage: 1.56 Tb - (was 1.69 Tb last time)
    * Bandwidth:
        * October: 16.67 Tb
        * November: 15.9 Tb
        * December: 30.34Tb
...
* Done (Milestone [ID](https://github.com/jenkins-infra/helpdesk/milestone/[ID]?closed=1))
  * Support
    ...
    * [Jira no longer sends emails to jenkinsci-cert@googlegroups.com](https://github.com/jenkins-infra/helpdesk/issues/5013)
    * [Archive `jenkinsci/jx-pipelines-plugin`](https://github.com/jenkins-infra/helpdesk/issues/5002)
  ...
  * Keep infrastructure sane and maintainable
    * [Update ci.jenkins.io, trusted.ci, cert.ci and release.ci to latest LTS version 2.541.2](https://github.com/jenkins-infra/helpdesk/issues/5009)
...
* New items:
  ...
  * Keep infrastructure up to date
    * Credentials renewals (issues to be created)

* Work in Progress (Milestone [196](https://github.com/jenkins-infra/helpdesk/milestone/196))
  * Support
...
* TODO (Next milestone: https://github.com/jenkins-infra/helpdesk/milestone/197)
...
* Issues added to the next [milestone](https://github.com/jenkins-infra/helpdesk/milestone/197):
...
* [x] Publish this meeting record on Youtube: https://youtu.be/q7BY-8kTH9o
* [x] Publish a topic in community.jenkins.io with the tag `meeting`: https://community.jenkins.io/t/infrastructure-team-meeting-march-3-2026/36352
* [x] Publish this meeting note on [jenkins-infra/documentation](https://github.com/jenkins-infra/documentation) 

Next meeting note - [2026-03-10](https://github.com/jenkins-infra/documentation/blob/main/meetings/2026-03-10.md) 
